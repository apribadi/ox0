...
static LexerState const lexer_transition_table[LEXER_STATE_COUNT_NONTERMINAL][CHARACTER_CLASS_COUNT] = {
  [LEXER_STATE_ID] = {
    [CHARACTER_CLASS_UNUSED] = LEXER_STATE_COMPLETE_ID,
    [CHARACTER_CLASS_ALPHA] = LEXER_STATE_ID,
    [CHARACTER_CLASS_DIGIT] = LEXER_STATE_ID,
    [CHARACTER_CLASS_HASH] = LEXER_STATE_COMPLETE_ID,
    [CHARACTER_CLASS_MINUS] = LEXER_STATE_COMPLETE_ID,
    [CHARACTER_CLASS_NEWLINE] = LEXER_STATE_COMPLETE_ID,
  ...
  [LEXER_STATE_MINUS] = {
    ...
    [CHARACTER_CLASS_ALPHA] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_DIGIT] = LEXER_STATE_NUM,
    [CHARACTER_CLASS_HASH] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_MINUS] = LEXER_STATE_OP,
    [CHARACTER_CLASS_NEWLINE] = LEXER_STATE_COMPLETE_OP,
  ...
  [LEXER_STATE_NUM] = {
    ...
    [CHARACTER_CLASS_ALPHA] = LEXER_STATE_COMPLETE_NUM,
    [CHARACTER_CLASS_DIGIT] = LEXER_STATE_NUM,
    [CHARACTER_CLASS_HASH] = LEXER_STATE_COMPLETE_NUM,
    [CHARACTER_CLASS_MINUS] = LEXER_STATE_COMPLETE_NUM,
    [CHARACTER_CLASS_NEWLINE] = LEXER_STATE_COMPLETE_NUM,
  ...
  [LEXER_STATE_OP] = {
    [CHARACTER_CLASS_UNUSED] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_ALPHA] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_DIGIT] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_HASH] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_MINUS] = LEXER_STATE_OP,
    [CHARACTER_CLASS_NEWLINE] = LEXER_STATE_COMPLETE_OP,
    [CHARACTER_CLASS_NULL] = LEXER_STATE_COMPLETE_OP,
